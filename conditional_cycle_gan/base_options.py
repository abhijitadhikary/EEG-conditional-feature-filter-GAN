...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', type=str, default=os.path.join('datasets', 'eeg'), help='path to dataset directory')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='EEG_conditional', help='chooses how datasets are loaded. [unaligned | aligned | single | EEG_conditional]')
